...
try:
    if not os.path.exists(STATIC_ROOT_DIR):
        ...
        print(u"Создана папка: " + STATIC_ROOT_DIR)

    if not os.path.exists(CSS_DIR):
        os.makedirs(CSS_DIR)
        print(u"Создана папка: " + CSS_DIR)

    if not os.path.exists(IMG_DIR):
        os.makedirs(IMG_DIR)
        print(u"Создана папка: " + IMG_DIR)

except Exception as e:
    print(u"Ошибка при создании папок: " + str(e))
...
if not os.path.exists(MEDIA_ROOT):
    ...
    print(u"Создана папка для медиа: " + MEDIA_ROOT)
